...
const nextite=document.querySelector("#nextitemon");
const previou=document.querySelector("#previouson"); 
let containingslide=document.querySelector("#image-caro"); 



 
nextite.addEventListener("click",function() {
    console.log('red');
   
      count=(count < 1 )? count+1:1;
      containingslide.style.transform='translateX('+(count)*-50+'%)'
     /* if (count===0) {
       ...
       previou.style.visibility='visible'
       nextite.style.visibility ='hidden'


  })
  previou.style.visibility='hidden'
